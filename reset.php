        	...
        	<div class="account-bg">
                <div class="card-box m-b-0">
                    ...
                    <div class="m-t-10 p-20">
                        ...
                        <form class="m-t-20" id="dataform" action="controller.php?flag=reset_password" method="POST">
                            ...
                            <div class="form-group text-center row m-t-10">
                                <div class="col-xs-12">
                                    <button class="btn btn-success btn-block waves-effect waves-light" type="submit">Reset</button>
                                </div>
                            </div>
